...
**Status:** Complete on 2026-09-14. Final behavior: 311/311. The final
trace-backed answer window completed 311/311 with scores 4.402/4.241/4.521 and
all 137 sub-5 cases privacy-safely classified from their scored execution.
...
- [x] **Step 1: Write failing redaction and classification tests**
...
- [x] **Step 3: Implement immutable diagnostic models and precedence**
...
- [x] **Step 4: Make behavior and answer evaluation share one execution trace**
...
- [x] **Step 5: Add aggregate CLI/dashboard reporting**
...
- [x] **Step 1: Write failing model-boundary tests**
...
- [x] **Step 2: Write failing deterministic assembly matrix**
...
- [x] **Step 4: Implement draft construction from occurrence-bound facts**
...
- [x] **Step 5: Implement deterministic proposal assembly**
...
- [x] **Step 1: Write failing zero-provider-call regressions**
...
- [x] **Step 2: Write failing bounded-decision prompt tests**
...
- [x] **Step 3: Write failing invalid-decision stop tests**
...
- [x] **Step 5: Implement the decision-only provider call**
...
- [x] **Step 6: Remove full-proposal overlay from the live path**
...
- [x] **Step 7: Emit privacy-safe decision lifecycle events**
...
- [x] **Step 8: Run focused suites and commit**
...
- [x] **Step 1: Add the failing synthetic public-pipeline regression**
...
- [x] **Step 2: Run the regression and record the exact failing invariant/fact**
...
- [x] **Step 3: Compare working and failing occurrence graphs**
...
- [x] **Step 4: Implement the generic span-ownership correction**
...
- [x] **Step 5: Run detector, compiler, runtime, and parity suites**
...
- [x] **Step 1: Add failing evaluator-boundary tests**
...
- [x] **Step 3: Audit each legacy malformed expectation locally**
...
- [x] **Step 4: Migrate valid local expectations**
...
- [x] **Step 5: Lock explicit unsupported capability decisions**
...
- [x] **Step 6: Run evaluator and safety suites and commit**
...
- [x] **Step 1: Run one non-private provider health probe**
...
- [x] **Step 2: Run the complete behavior corpus when healthy**
...
- [x] **Step 3: Run the complete answer-quality corpus when healthy**
...
- [x] **Step 4: Classify every sub-5 case**
...
- [x] **Step 5: Fix confirmed shared defects one at a time**
...
- [x] **Step 6: Compare accepted strict baseline, permissive historical result,
and current result**
...
- [x] **Step 1: Run complete deterministic discovery**

Run: `python -m unittest discover -s week5 -p '*test*.py' -v`

- [x] **Step 2: Run static and compilation checks**

Run Ruff check, Ruff format check over the current 45-file scope, Python compilation,
and `git diff --check`. Record any pre-existing formatter drift separately and
ensure no new drift remains.

- [x] **Step 3: Verify private dataset and benchmark**
...
- [x] **Step 4: Review privacy and forbidden architecture**
...
- [x] **Step 5: Update handoffs with evidenced results**
...
- [x] **Step 6: Commit coherent changes and push**
...
- [x] **Step 7: Prove clean worktrees**
